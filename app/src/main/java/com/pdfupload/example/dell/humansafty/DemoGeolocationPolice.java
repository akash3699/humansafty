...
public class DemoGeolocationPolice extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        com.google.android.gms.location.LocationListener {
    String targeturl=SERVER_ADDRESS+"HumanSafty/police.php?apicall=login";
    String targeturl2=SERVER_ADDRESS+"HumanSafty/balika.php?apicall=login";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_geolocation_police);

        sp=getApplicationContext().getSharedPreferences("login",MODE_PRIVATE);
        a =  sp.getString("stuid",null);
        Log.d("oyee",a);
         sendNotification();
        mLatitudeTextView = (TextView) findViewById((R.id.lat1_pol));
        mLongitudeTextView = (TextView) findViewById((R.id.long1_pol));
        getLocation();
...
startActivity(new Intent(DemoGeolocation.this,log.class));
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            {
                                Toast.makeText(DemoGeolocationPolice.this, "Notification Send", Toast.LENGTH_SHORT).show();
                            }
                            else

                            {
                                Toast.makeText(DemoGeolocationPolice.this, message, Toast.LENGTH_SHORT).show();
                            }
    ...
    private void parse(JSONArray jsonArray) {
        ...
        startActivity(new Intent(DemoGeolocationPolice.this,location_tracker.class));
    }
